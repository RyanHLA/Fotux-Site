      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="font-body text-sm leading-relaxed text-slate-400 max-w-xs">
              A plataforma de provas fotográficas para fotógrafos profissionais que valorizam seu tempo e a experiência dos clientes.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="font-body text-sm hover:text-white transition-colors flex items-center gap-2"
                >
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-body text-sm text-slate-500">
            © {year} Fotux. Todos os direitos reservados.
          </p>
          <div className="flex items-center gap-5">
            <a href="#" className="font-body text-xs text-slate-500 hover:text-slate-300 transition-colors">
              Privacidade
            </a>
            <a href="#" className="font-body text-xs text-slate-500 hover:text-slate-300 transition-colors">
              Termos de uso
